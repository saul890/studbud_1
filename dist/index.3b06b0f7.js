...
function renderTask(task1) {
    ...
    checkbox.addEventListener("change", function(event) {
        if (this.checked) item.classList.add("blue") // if checked, add blue styling
        ;
        else item.classList.remove("blue") // if unchecked, remove blue styling
        ;
    });
...
},{}]},["2xDT7","2OD7o"], "2OD7o", "parcelRequire48b2")
