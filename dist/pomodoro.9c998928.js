...
startBtn.addEventListener("click", ()=>{
    ...
    if (btn === "focus") mins = +sessionStorage.getItem("focusTime") || 25; // If btn value is 'focus', set mins to focus value
    else if (btn === "break") mins = +sessionStorage.getItem("breakTime") || 5; // If btn value is 'break', set mins to break value
    else mins = +sessionStorage.getItem("restTime") || 15; // If btn value is 'rest', set mins to rest value
